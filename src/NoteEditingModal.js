...
class NoteEditingModal extends Component {
    ...
    componentWillMount() {
        ...
        .then((response) => {
            ...
            this.setState({ notesCollectionObject: response.data.contents,
                attachmentsCollectionObject : response.data.attachments,
                 isLoading: false })
        })
    }
    ...
    editedSomething(){
        this.setState({ shouldChildContentSort : false })
    }
    ...
    render() {
        ...
        const contentList = {
            ...
            shouldChildContentSort={this.state.shouldChildContentSort}
            notesCollectionObject={this.state.notesCollectionObject}
            editedSomething = {this.editedSomething.bind(this)}
            ...
            attachmentsCollectionObject = { this.state.attachmentsCollectionObject }
            />,
        ...
        return (
            ...
            <Card extra={<Switch disabled={(this.state.key === 'tab1') ? false : true} checked = { this.state.shouldChildContentSort } checkedChildren="Sorted" unCheckedChildren="Unsorted" onChange={this.toSortEntries.bind(this)} />}
